...
identity для двух пустых векторов. Конкретный порядок floating-point накопления
не является гарантией API; улучшение численной устойчивости отложено до
...
инициализации результата. Порядок floating-point накопления не является
гарантией API.
